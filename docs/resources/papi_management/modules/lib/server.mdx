...
description: Documentation for server-side library functions in the 420 resource. These functions provide utilities for spawning vehicles, managing entities, and handling server-side operations within the Qbox framework.
---
