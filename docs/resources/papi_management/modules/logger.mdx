...
keywords: [qbox, fivem, modules, logger]
description: Documentation for the logger module in the 420 resource. This module provides logging functionality that can output to both Discord webhooks and ox_lib's logging system, supporting various log levels and customization options.
---
...
```lua
local logger = require '@papi_management.modules.logger'
