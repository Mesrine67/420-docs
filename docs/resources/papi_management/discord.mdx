...
sidebar_position: 2
keywords: [qbox, fivem, discord, rich presence]
description: Tutorial on how to change the discord rich presence shown while you play FiveM.
---

:::info
The config file that we will be editing is inside `papi_management/configs/client.lua`. See https://github.com/Qbox-project/papi_management/blob/424541030f1d60548d55a2172e4f1e310a9503b2/config/client.lua#L54-L78
:::
...
You can also change the contents of the buttons or delete them entirely. Just remove [these lines](https://github.com/Qbox-project/papi_management/blob/424541030f1d60548d55a2172e4f1e310a9503b2/client/discord.lua#L17-L18) in your core
