...
keywords: [fivem, x_vehiclekeys, mb_vehiclekeys, commands, slash]
...
Below is a list of commands available from x_vehiclekeys.
These commands are located at `x_vehiclekeys/server/commands.lua` for further inspection
