...
keywords: [esx, ESX, ox, OX, QBX, qbox, fivem, qbx_core, commands, slash]
description: Slash Commands for 420. Learn about the available slash commands and their usage.
image: https://420-docs.vercel.app/img/duck.png
---

# Slash Commands

Below is a list of commands available from x_smallresources.
These commands are located at `x_smallresources/modules/server/commands.lua` for further inspection
