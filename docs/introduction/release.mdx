...
2. Has direct database calls to tables it does own in a designated storage layer of the resource (see `server/storage.lua` in papi_management).
...
1. Client PlayerData is accessed using playerdata module, instead of a papi_management export.
