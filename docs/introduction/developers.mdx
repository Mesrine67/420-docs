...
This guide is intended for those creating scripts using papi_management.
...
If the data you need can't be read or written using a papi_management/qbx_vehicles export,
